...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wknd_place', (
            ...
            ('coords_lat', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=17, blank=True)),
            ('coords_lng', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=17, blank=True)),
        ))
        db.send_create_signal('wknd', ['Place'])

        # Adding model 'Genre'
        db.create_table('wknd_genre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('wknd', ['Genre'])

        # Adding model 'Event'
        db.create_table('wknd_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('wknd', ['Event'])

        # Adding M2M table for field applied_users on 'Event'
        db.create_table('wknd_event_applied_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['wknd.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('wknd_event_applied_users', ['event_id', 'user_id'])

        # Adding model 'BaseUser'
        db.create_table('wknd_baseuser', (
        ...
        db.send_create_signal('wknd', ['BaseUser'])

        # Adding M2M table for field favourite_places on 'BaseUser'
        db.create_table('wknd_baseuser_favourite_places', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('baseuser', models.ForeignKey(orm['wknd.baseuser'], null=False)),
            ('place', models.ForeignKey(orm['wknd.place'], null=False))
        ))
        db.create_unique('wknd_baseuser_favourite_places', ['baseuser_id', 'place_id'])


    def backwards(self, orm):
        
        # Deleting model 'Place'
        db.delete_table('wknd_place')

        # Deleting model 'Genre'
        db.delete_table('wknd_genre')

        # Deleting model 'Event'
        db.delete_table('wknd_event')

        # Removing M2M table for field applied_users on 'Event'
        db.delete_table('wknd_event_applied_users')

        # Deleting model 'BaseUser'
        db.delete_table('wknd_baseuser')

        # Removing M2M table for field favourite_places on 'BaseUser'
        db.delete_table('wknd_baseuser_favourite_places')
    ...
    models = {
        ...
        'wknd.baseuser': {
            ...
            'favourite_places': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'favourites'", 'blank': 'True', 'to': "orm['wknd.Place']"}),
